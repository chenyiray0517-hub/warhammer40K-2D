...
- [x] 特殊任務關卡 — ✅ 2026-06-01
- [ ] 第 5 Boss 名稱與機制確認 / 補完
- [x] 任務終端第三關「物資掠取 SUPPLY RAID」— ✅ 2026-06-06
- [x] 任務終端第四關「爆破任務 DEMOLITION」— ✅ 2026-06-06
...
- **2026-06-06** — **任務終端第四關「爆破任務 DEMOLITION」**：蟲族數量爆炸，主角滲透工廠設置炸藥殲滅蟲群。三段背景：太空外景→工廠內部（暗天花板＋管道＋熔爐光暈＋金屬地板格）→炸彈放置點（遠方蟲群飛翔剪影）。x≥8500 自動放置炸藥箱，啟動40秒塔防防守；防守成功後出現Boss「裂鐵掠奪者 IRONRIFT RAVAGER」（HP 25000）三段AI：散彈步槍衝刺/熔爐彈投擲/狂暴高速衝鋒，大絕「工廠爆裂」(4枚熔爐炸彈+5個火焰池+7向地面衝擊+衝刺)。擊敗後 `explosionActive=true`，背景呈現爆炸閃光+持續殘焰，直到撤離結束。勝利文字「裂鐵掠奪者已殞滅 — DEMOLITION CLEAR」。
